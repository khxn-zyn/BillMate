...
export default function Home() {
  ...
  const sectionHeading = (text) => (
    <h2 className="fade-up" style={{ color: '#fff', fontWeight: 800, fontSize: 'clamp(1.6rem, 3.5vw, 2.2rem)', letterSpacing: '-0.03em', textAlign: 'center', marginBottom: '0.6rem', lineHeight: 1.2 }} dangerouslySetInnerHTML={{ __html: text }} />
  )
  ...
  const divider = () => (
    <div style={{ borderTop: '1px solid #1e1e30', marginBottom: '5rem' }} />
  )
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f' }}>
      <style>{`
        ...
        .btn-ghost:hover { color: #fff !important; border-color: rgba(255,255,255,0.25) !important; transform: translateY(-2px); }
        ...
        .stat-cell:hover { background: #16162a !important; box-shadow: inset 0 0 40px rgba(124,92,252,0.12); }
      ...
      <div className={`sticky-cta${showSticky ? '' : ' hidden'}`}>
        <p style={{ color: '#d1d5db', fontSize: '0.88rem', fontWeight: 500, margin: 0 }}>Free to start. No credit card.</p>
      ...
      {/* Nav */}
      <nav className="lp-nav" style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(10,10,15,0.92)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #1e1e30', padding: '16px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Link href="/" style={{ color: '#fff', fontWeight: 800, fontSize: '1.15rem', letterSpacing: '-0.03em', textDecoration: 'none' }}>
          Bill<span style={{ color: '#7c5cfc' }}>Mate</span>
        </Link>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <Link href="/login" style={{ color: '#6b7280', fontSize: '0.88rem', fontWeight: 500, padding: '8px 14px', textDecoration: 'none' }}>Log in</Link>
      ...
      <main className="lp-main" style={{ paddingTop: '96px', paddingLeft: '24px', paddingRight: '24px', paddingBottom: '0' }}>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 10 }}>
          ...
          <h1 className="fade-up" style={{ fontSize: 'clamp(2.4rem, 6vw, 3.8rem)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.1, color: '#fff', marginBottom: '1.2rem' }}>
          ...
          <div className="lp-cta-row fade-up" style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '1.4rem' }}>
            ...
            <button onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })} className="btn-ghost" style={{ background: 'transparent', color: '#9ca3af', fontWeight: 600, fontSize: '0.95rem', padding: '12px 32px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.15)', cursor: 'pointer', transition: 'color 0.2s, border-color 0.2s, transform 0.15s' }}>
              See how it works
            </button>
          </div>

          <p className="fade-up" style={{ color: '#4b5563', fontSize: '0.82rem', marginBottom: '4rem' }}>
            Australian-owned&nbsp;&nbsp;•&nbsp;&nbsp;Free to start&nbsp;&nbsp;•&nbsp;&nbsp;No credit card needed
          </p>
        </div>

        {/* Stats bar */}
        <div className="stats-bar fade-up" style={{ maxWidth: '700px', margin: '0 auto 5rem', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: '#1e1e30', border: '1px solid #1e1e30', borderRadius: '14px', overflow: 'hidden', position: 'relative', zIndex: 10 }}>
          {[
            ...
            <div key={value} className="stat-cell" style={{ background: '#13131a', padding: '1.6rem 1rem', textAlign: 'center' }}>
              <p style={{ color: '#fff', fontWeight: 800, fontSize: '1.5rem', letterSpacing: '-0.03em', marginBottom: '4px' }}>{value}</p>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto', position: 'relative', zIndex: 10 }}>
          ...
          <div id="how-it-works" style={{ marginBottom: '5rem' }}>
            ...
            <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
              {[
                ...
                <div key={step} className="hover-card fade-up" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '14px', padding: '1.6rem' }}>
                  <p style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.1em', color: '#7c5cfc', marginBottom: '0.8rem' }}>STEP {step}</p>
                  <p style={{ color: '#fff', fontWeight: 700, fontSize: '0.95rem', marginBottom: '0.5rem' }}>{title}</p>
          ...
          <div style={{ marginBottom: '5rem' }}>
            ...
            <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
              {[
                ...
                <div key={title} className="hover-card fade-up" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '14px', padding: '1.6rem' }}>
                  <span style={{ fontSize: '1.4rem', display: 'block', marginBottom: '0.8rem' }}>{icon}</span>
                  <p style={{ color: '#fff', fontWeight: 700, fontSize: '0.95rem', marginBottom: '0.4rem' }}>{title}</p>
                  <p style={{ color: '#6b7280', fontSize: '0.85rem', lineHeight: 1.65, margin: 0 }}>{desc}</p>
                </div>
              ))}
            </div>
          ...
          <div style={{ marginBottom: '5rem' }}>
            ...
            <div className="fade-up" style={{ display: 'flex', flexWrap: 'wrap', gap: '0.7rem', justifyContent: 'center' }}>
              {[
                ...
                <span key={label} className="industry-pill" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '100px', padding: '0.5rem 1.2rem', fontSize: '0.88rem', color: '#d1d5db', fontWeight: 500, cursor: 'default', transition: 'border-color 0.2s, color 0.2s' }}>
                  {emoji} {label}
                </span>
              ))}
            </div>
          ...
          <div style={{ marginBottom: '5rem' }}>
            ...
            <div className="testimonials-grid fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
              {[
                ...
                <div key={name} className="hover-card" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '14px', padding: '1.6rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <p style={{ color: '#d1d5db', fontSize: '0.9rem', lineHeight: 1.7, flex: 1, margin: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', borderTop: '1px solid #1e1e30', paddingTop: '1rem' }}>
                    ...
                    <div>
                      <p style={{ color: '#fff', fontWeight: 600, fontSize: '0.85rem', margin: 0 }}>{name}</p>
          ...
          {/* Founder */}
          <div className="fade-up" style={{ marginBottom: '5rem', background: '#13131a', border: '1px solid #1e1e30', borderRadius: '20px', padding: '2.5rem', textAlign: 'center' }}>
            <p style={{ color: '#d1d5db', fontSize: '1.1rem', lineHeight: 1.8, fontStyle: 'italic', maxWidth: '560px', margin: '0 auto 1.6rem' }}>
        ...
        <div id="pricing" style={{ maxWidth: '700px', margin: '0 auto 5rem', position: 'relative', zIndex: 10 }}>
          ...
          <div className="pricing-grid fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            ...
            {/* Free */}
            <div className="hover-card" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '20px', padding: '2rem', display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ color: '#fff', fontSize: '2.4rem', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1, marginBottom: '0.25rem' }}>A$0</p>
              ...
              <ul style={{ listStyle: 'none', flex: 1, marginBottom: '1.5rem' }}>
                {['Unlimited invoices', 'PDF export', 'GST auto-calculation', 'Track payments'].map(f => (
                  <li key={f} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '0.35rem 0', borderBottom: '1px solid #1e1e30', fontSize: '0.88rem', color: '#d1d5db' }}>
            ...
            {/* Pro */}
            <div className="hover-card" style={{ background: '#13131a', border: '2px solid #7c5cfc', borderRadius: '20px', padding: '2rem', display: 'flex', flexDirection: 'column', position: 'relative', boxShadow: '0 0 40px rgba(124,92,252,0.12)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '0.25rem' }}>
                <p style={{ color: '#fff', fontSize: '2.4rem', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1, margin: 0 }}>A$7</p>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto 5rem', position: 'relative', zIndex: 10 }}>
          ...
          <div className="fade-up" style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '16px', overflow: 'hidden' }}>
            <table className="compare-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={feature} style={{ borderBottom: i < 6 ? '1px solid #1e1e30' : 'none', background: i % 2 === 0 ? 'transparent' : 'rgba(255,255,255,0.01)' }}>
                    <td style={{ padding: '12px 20px', color: '#d1d5db', fontSize: '0.88rem' }}>{feature}</td>
                    <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                      {typeof bm === 'boolean'
                        ? <span style={{ color: bm ? '#7c5cfc' : '#374151', fontWeight: 700, fontSize: '1rem' }}>{bm ? '✓' : '✗'}</span>
                        : <span style={{ color: '#7c5cfc', fontWeight: 700, fontSize: '0.85rem' }}>{bm}</span>}
                    </td>
                    <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                      {typeof xero === 'boolean'
                        ? <span style={{ color: xero ? '#6b7280' : '#374151', fontSize: '1rem' }}>{xero ? '✓' : '✗'}</span>
                        : <span style={{ color: '#6b7280', fontSize: '0.85rem' }}>{xero}</span>}
                    </td>
                    <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                      {typeof myob === 'boolean'
                        ? <span style={{ color: myob ? '#6b7280' : '#374151', fontSize: '1rem' }}>{myob ? '✓' : '✗'}</span>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto 5rem', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            {faqs.map((faq, i) => (
              <div key={i} className="faq-item" onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{ background: '#13131a', border: '1px solid #1e1e30', borderRadius: '12px', overflow: 'hidden', cursor: 'pointer' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.1rem 1.4rem', gap: '1rem' }}>
                  <p style={{ color: '#fff', fontWeight: 600, fontSize: '0.92rem', margin: 0 }}>{faq.q}</p>
                ...
                {openFaq === i && (
                  <div style={{ padding: '0 1.4rem 1.1rem', borderTop: '1px solid #1e1e30' }}>
      ...
      <footer style={{ background: '#0a0a0f', borderTop: '1px solid #1a1a2e', padding: '48px 24px 36px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div className="footer-inner" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '32px', marginBottom: '40px' }}>
            <div>
              <p style={{ color: '#fff', fontWeight: 800, fontSize: '1.1rem', letterSpacing: '-0.02em', marginBottom: '4px' }}>Bill<span style={{ color: '#7c5cfc' }}>Mate</span></p>
              <p style={{ color: '#4b5563', fontSize: '0.8rem', margin: 0 }}>ABN 46 849 678 875</p>
            </div>
          ...
          <div style={{ borderTop: '1px solid #1e1e30', paddingTop: '24px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
            <p style={{ color: '#374151', fontSize: '0.8rem', margin: 0 }}>© 2026 BillMate. All rights reserved.</p>
            <p style={{ color: '#4b5563', fontSize: '0.8rem', margin: 0 }}>Built in Australia 🇦🇺</p>
          </div>
        </div>
      </footer>
