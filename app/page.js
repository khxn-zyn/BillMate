      ...
      <nav className="lp-nav" style={{ position: 'sticky', top: 0, zIndex: 50, background: t.navBg, backdropFilter: 'blur(14px)', borderBottom: `1px solid ${t.navBorder}`, padding: '16px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{ width: 38, height: 38, borderRadius: '50%', background: 'transparent', border: `1px solid ${theme === 'dark' ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.2)'}`, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'box-shadow 0.2s, border-color 0.2s, border-style 0.2s, color 0.2s', color: theme === 'dark' ? 'rgba(255,255,255,0.75)' : 'rgba(0,0,0,0.6)', flexShrink: 0 }}
          >
            {theme === 'dark' ? (
